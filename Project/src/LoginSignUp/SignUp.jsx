...
function SignUp() {
    ...
    const handleSubmit = (e)=>{
        ...
        {
          const existingEmail = userData.filter((user)=>user.email == email);
        ...
        <div className="bg-white p-4 p-md-5 rounded shadow-sm">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row text-start gy-3 gy-md-4 overflow-hidden">
              ...
              <div className="col-12">
                ...
                <input value={cpassword} onChange={(e)=>{setCpassword(e.target.value)}} type="password" className="form-control" />
              </div>
              <div className="col-12">
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="d-flex gap-3 justify-content-md-center flex-column flex-md-row">
